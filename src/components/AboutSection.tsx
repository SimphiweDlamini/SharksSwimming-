      ...
      >
        <Container maxW="800px" px={6}>
          ...
          <Text fontFamily="Roboto Slab, serif" fontSize="lg" lineHeight="tall">
            Sharks Swimming Club is dedicated to nurturing swimmers of all ages
            and skill levels. Founded in 2005, we pride ourselves on fostering a
            supportive and competitive environment where every swimmer can
            thrive.
          </Text>
        </Container>
      </Box>
